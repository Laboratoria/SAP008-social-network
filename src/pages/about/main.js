export default () => {
  ...
  const template = `
    ...
    <main id="about-page">
      <h2 id="about-title">SOBRE <strong class="about-rebu">REBU</strong></h2>
      <p class="about-paragraph"><strong class="about-rebu">REBU</strong> é uma rede social de interação & comunidade feita para mulheres lésbicas.</p> 
      ...
      <p class="about-paragraph">Não importa onde você more, <strong class="about-rebu">REBU</strong> te prorporciona se conectar com outras mulheres e criar sua própria rede.</p>
    </main>
  `;
